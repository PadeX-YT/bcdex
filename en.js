const translations_en = {
    "page_title_index": "BCDeX - Install Windows without USB or DVD",
    "nav_home": "Home",
    ...
    "index_badge_hero": "BCDeX 3.2 Advanced • The Modern Way to Install Windows",
    "index_main_title": "Install or Reinstall Windows without USB or DVD.",
    "index_main_slogan": "Installing Windows has never been this fast, safe and easy!",
    "index_main_description": "BCDeX automates the entire installation process for Windows 11, 10, 8.1, and 7. Create direct boot partitions on your disk, prepare universal bootable USB drives with one click, and boost performance with Turbo Mode. 100% automatic, safe, and reversible.",
    "index_hero_bullet1": "Direct boot from internal disk partition",
    "index_hero_bullet2": "Universal bootable USB compatible with UEFI & Legacy BIOS",
    "index_hero_bullet3": "100% Reversible: restore disk space with 1 click",
    "index_main_download_button": "Download Free",
    "index_main_tutorial_button": "Watch Video Guide",
    "index_steps_title": "How Does BCDeX Work?",
    "index_steps_subtitle": "Reinstalling your PC is as simple as 3 clear steps without technical complexity.",
    "index_step1_title": "1. Select your Windows ISO",
    "index_step1_desc": "Load any official Microsoft ISO or custom edition. BCDeX automatically analyzes and validates disk space.",
    "index_step2_title": "2. Choose your Installation Method",
    "index_step2_desc": "Install directly from your hard drive with a safe 1-click partition, or create a universal bootable USB.",
    "index_step3_title": "3. Reboot, Install & Optimize",
    "index_step3_desc": "Windows setup launches automatically. Once finished, reclaim disk space instantly with Undo Changes.",
    "index_features_title": "Everything BCDeX Does for You",
    "index_features_subtitle": "Engineered so anyone can install and optimize Windows like a seasoned pro.",
    "index_feature1_title": "Direct Installation from Hard Drive",
    "index_feature1_description": "No need to look for or format USB drives. BCDeX prepares an isolated temporary partition and configures boot parameters automatically.",
    "index_feature2_title": "Universal Bootable USB (UEFI & BIOS)",
    "index_feature2_description": "Prefer a portable USB drive? Prepare memory sticks with intelligent formatting compatible with any modern or older PC.",
    "index_feature3_title": "Turbo Mode & Integrated Debloat",
    "index_feature3_description": "Enjoy a lightning-fast Windows from day one. Remove bloatware, disable heavy telemetry, and liberate system resources.",
    "index_feature4_title": "100% Reversible ('Undo Changes')",
    "index_feature4_description": "Zero system clutter. With a single click, delete the temporary partition, clean the boot menu, and reclaim all disk space.",
    "index_feature5_title": "Full Compatibility with Any ISO",
    "index_feature5_description": "Supports official Microsoft ISOs (Windows 11 25H2, 24H2, 10, 8.1), MiniOS, Lite builds, and custom unattended setups.",
    "index_feature6_title": "Zero Terminal Commands Required",
    "index_feature6_description": "Forget complex diskpart or bcdedit console scripts. The clean GUI handles all technical operations in the background safely.",
    "index_compare_title": "Why Choose BCDeX over Traditional Methods?",
    ...
    "donations_cta_combo": "Your name and avatar could be here. Discover how",
    "donations_cta_here": "Support BCDeX",
    "index_cta_title": "Ready to Reinstall Windows the Smart Way?",
    "index_cta_subtitle": "Download BCDeX today and experience the fastest, cleanest installation workflow.",
    ...
    "feature_1_title": "Direct-to-Disk Internal Partition",
    "feature_1_desc": "BCDeX creates a temporary, non-destructive boot environment directly on your hard drive. It extracts essential ISO files and configures the Windows BCD bootloader, allowing clean installations without any USB drive or DVD.",
    "feature_2_title": "Universal Bootable USB Creation",
    "feature_2_desc": "Transform any USB drive into a high-compatibility Windows installer. The tool extracts and prepares the native boot structure with dual support for modern UEFI systems (GPT) and legacy BIOS motherboards (MBR).",
    "feature_3_title": "Multi-ISO USB with Ventoy Engine (v3.2 Advanced)",
    "feature_3_desc": "Coming soon in version 3.2 Advanced: integrates the proven Ventoy to Disk technology to boot multiple operating systems from a single USB. In this mode, no file extraction is needed—simply copy full Windows and Linux ISO files and boot any distro instantly.",
    "info_compatibility_title": "Verified and Certified Compatibility (v3.2 Advanced)",
    "info_feature_1_title": "Direct-to-Disk Internal Partition",
    "info_feature_1_desc": "BCDeX creates a temporary, non-destructive boot environment directly on your hard drive. It extracts essential ISO files and configures the Windows BCD bootloader, allowing clean installations without any USB drive or DVD.",
    "info_feature_2_title": "Universal Bootable USB Creation",
    "info_feature_2_desc": "Transform any USB drive into a high-compatibility Windows installer. The tool extracts and prepares the native boot structure with dual support for modern UEFI systems (GPT) and legacy BIOS motherboards (MBR).",
    "info_feature_3_title": "Multi-ISO USB with Ventoy Engine (v3.2 Advanced)",
    "info_feature_3_desc": "Coming soon in version 3.2 Advanced: integrates the proven Ventoy to Disk technology to boot multiple operating systems from a single USB. In this mode, no file extraction is needed—simply copy full Windows and Linux ISO files and boot any distro instantly.",
    ...
    "article_modo_turbo_v30_title": "BCDeX 3.0 Core: Reinforced Turbo Mode",
    "article_modo_turbo_v30_description": "See what the new version optimizes, which services it touches, and how to restore them if needed.",
    ...
    "article_25h2_back_to_all": "â† Back to all articles",
    ...
    "other_article_archivo_desatendido": "BCDeX â€“ Unattended File Guide",
    ...
    "article_modo_turbo_back_to_all": "â† Back to all articles",
    "page_title_article_1": "BCDeX 2.3: Turbo Mode â€“ What it deactivates and how to re-enable it"
,
    "article_1_title": "ðŸš€ BCDeX 2.3: Turbo Mode â€“ What it deactivates and how to re-enable it",
    ...
    "section_1_title": "ðŸ’¡ What exactly does Turbo Mode do?",
    ...
    "section_2_title": "ðŸ”§ Did something you need turn off?",
    ...
    "section_2_subtitle_1": "ðŸ“‹ List of basic services that Turbo Mode touches",
    "section_3_title": "ðŸ“‹ Other services you might find turned off",
    ...
    "section_4_title": "ðŸ•’ Services on â€œpauseâ€ (Manual): they start automatically if you need them",
    ...
    "section_5_title": "ðŸ—‘ï¸ Application and component uninstallation",
    ...
    "important_note_title": "ðŸš¨ Important: Variability in Windows!",
...
,
    "article_win11_25h2_back_to_all": "â† Back to all articles",
    ...
    "section_win11_25h2_1_li1": "Go to <span class=\"font-semibold\">Computer Configuration â†’ Administrative Templates â†’ Windows Components</span>.",
    "section_win11_25h2_1_li2": "Find the new option called <span class=\"font-semibold\">Remove preinstalled apps</span>.",
    "section_win11_25h2_1_li3": "Doubleâ€‘click it.",
    ...
    "section_win11_25h2_2_p5": "After enabling the policy, go to <span class=\"font-semibold\">Settings â†’ Apps â†’ Installed apps</span> and remove the apps you want.",
    ...
    "section_win11_25h2_5_li3": "Thirdâ€‘party tools can still be useful for advanced removal.",
    ...
    "conclusion_win11_25h2_p2": "Removing bloatware has never been so easy â€” and official! Enjoy making Windows yours."
,
    "donations_page_title": "BCDeX: How the idea was born and who is behind the project",
    "donations_title": "Become a Project Partner",
    "donations_intro": "BCDeX is free and always will be thanks to the support of an incredible community. Your contribution is not just a donation: it's a fist bump to the project that already saved you from paying a technician, losing hours, or buying extra tools. It's an investment so that this tool â€”built by an enthusiast for enthusiastsâ€” continues to exist and improve.",
    "donations_why_title": "Why is your support so important?",
    "donations_why_item1_title": "ðŸš€ Drives new features",
    ...
    "donations_why_item2_title": "ðŸ›¡ï¸ Ensures the project's continuity",
    ...
    "donations_why_item3_title": "â˜• Fuels the passion (and the developer)",
    "donations_why_item3_text": "This is a oneâ€‘developer project. Every donation literally turns into coffee, hours of code, bug fixing, and user support. It's a way to say â€˜you helped me â€” hereâ€™s my realâ€‘life fist bumpâ€™.",
    ...
    "donations_how_text": "BCDeX keeps growing thanks to you. Your donationâ€”of any sizeâ€”is vital to fund maintenance, ensure stable servers, and accelerate the development of new features. Help us keep moving forward! Thank you for being a pillar of our community.",
...
,
    "section_sobre_el_creador_1_p1": "It all started when one day, after installing Windows for the umpteenth time on different PCs (some without working USB ports, others with BIOS that donâ€™t accept USB boot, others with very restrictive UEFIs...), I said to myself:",
    ...
    "section_sobre_el_creador_1_p4": "And he didnâ€™t mean it offensively. What he meant was that when developing something, you have to think absolutely everything from the end userâ€™s perspective, including those who have no idea about computing. The experience has to be so simple that anyone can do it without reading a manual.",
    "section_sobre_el_creador_1_p5": "That phrase clicked for me. And I set myself a goal: \"How can I make it so the user doesnâ€™t even have to mount the ISO?\"",
    "page_title_article_sobre_el_creador": "BCDeX: How the idea was born and who is behind the project",
    "article_sobre_el_creador_back_link": "â† Back to all articles",
    "article_sobre_el_creador_summary": "Hi, I'm JosÃ© 'PadeX' ðŸ‘‹ and if you're reading this, you probably already know my application BCDeX, or at least it sounds familiar. In this post I want to tell you a little about the story behind the project. Because yes, although it may seem like a magic app that appears on your desktop and creates a bootable partition as if by magic... behind it there are many sleepless nights, failed tests and liters of coffee â˜•.",
    ...
    "section_sobre_el_creador_2_p3": "So I decided to take the next step: create a simple but functional graphical interface that would guide the user through the entire process â€”from creating the partition to copying the ISO and configuring the boot.",
    ...
    "section_sobre_el_creador_3_p3": "Thus the name BCDeX was born: a fusion of the technical and the personal. ðŸ˜„",
    "section_sobre_el_creador_4_title": "And who is behind it?",
    "section_sobre_el_creador_4_p1": "As I told you before, I'm PadeX, and yes, I do everything: programmer, designer, tester, content creator and even technical support in the comments of my videos ðŸ˜….",
    ...
    "download_page_title": "BCDeX - Official Download",
    "download_header_title": "Download BCDeX",
    "download_header_subtitle": "You are just one click away from simplifying your Windows installations forever. Choose your recommended version.",
    "download_v32_title": "BCDeX 3.2 Advanced",
    "download_v30_title": "BCDeX 3.0 Core",
    "download_v23_title": "BCDeX 2.3",
    "download_v23_btn": "View v2.3 Downloads",
    "download_updated_on_label": "Updated on:",
    "download_features_title": "Main Features",
    "download_v23_b1": "Compatible with <strong>Windows 7</strong>, <strong>8</strong>, <strong>8.1</strong>, <strong>10</strong> and <strong>11</strong>",
    "download_v23_b2": "Creation of <strong>Bootable USB</strong> drives",
    "download_v23_b3": "<strong>Turbo Mode</strong> to release system resources",
    "download_v23_b4": "Support for <strong>UEFI</strong> and <strong>Legacy</strong> boot",
    "download_links_title": "Download Servers",
    "download_server_1": "⬇️ Server #1",
    "download_server_2": "⬇️ Server #2",
    "download_win7_compat_title": "Installing on Windows 7?",
    "download_win7_compat_desc": "Download package with .NET Framework 4.0 and necessary updates.",
    "download_win7_package_btn": "Download Windows 7 Package",
    "download_warning_title": "Important Notice & Security",
    "download_warning_text": "BCDeX interacts directly with the Boot Configuration Data (BCD). While completely safe, some antiviruses trigger false positive alerts due to its low-level utilities."
};
